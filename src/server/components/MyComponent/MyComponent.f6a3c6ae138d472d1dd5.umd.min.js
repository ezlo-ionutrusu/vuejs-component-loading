(function(e, t) {
  "object" === typeof exports && "object" === typeof module
    ...
    ? (exports["MyComponent.f6a3c6ae138d472d1dd5"] = t())
    : (e["MyComponent.f6a3c6ae138d472d1dd5"] = t());
    ...
    4447: function(e, t, n) {
      ...
      var o = function() {
          var e = this,
            t = e.$createElement,
            n = e._self._c || t;
          return n("h2", [e._v("Hello from the Distribution Server! " + e._s(e.title))]);
        },
        i = [],
        u = { props: { title: { required: !1, type: String } } },
        c = u;
      function f(e, t, n, r, o, i, u, c) {
        ...
        if (
          ...
          if (d.functional) {
            ...
            d.beforeCreate = s ? [].concat(s, f) : [f];
          }
        return { exports: e, options: d };
      }
      var d = f(c, o, i, !1, null, null, null),
        a = d.exports;
      t["default"] = a;
    }
  })["default"];
});
//# sourceMappingURL=MyComponent.f6a3c6ae138d472d1dd5.umd.min.js.map
